...
Route::add("/admin/store/developer/plugin/save", [\App\Controller\Admin\API\Store\Developer::class, "createOrUpdatePlugin"], "POST"); 
...
Route::add("/checkout", [\App\Controller\User\Index::class, "checkout"], "GET");  
...
Route::add("/shop/category", [\App\Controller\User\API\Index\Category::class, "available"], "POST");
Route::add("/shop/item", [\App\Controller\User\API\Index\Item::class, "list"], "POST");
Route::add("/shop/item/detail", [\App\Controller\User\API\Index\Item::class, "detail"], "POST");
Route::add("/shop/item/price", [\App\Controller\User\API\Index\Item::class, "getPrice"], "POST");

Route::add("/shop/order/trade", [\App\Controller\User\API\Index\Order::class, "trade"], "POST"); 
Route::add("/shop/order/getOrder", [\App\Controller\User\API\Index\Order::class, "getOrder"], "POST"); 
Route::add("/shop/order/cancel", [\App\Controller\User\API\Index\Order::class, "cancel"], "POST"); 
Route::add("/shop/order/download", [\App\Controller\User\API\Index\Order::class, "downloadOrder"], "GET"); 
...
Route::add("/pay", [\App\Controller\User\Pay\PayOrder::class, "pay"], "GET");  
Route::add("/pay", [\App\Controller\User\API\Pay\PayOrder::class, "pay"], "POST");  
Route::add("/pay/async", [\App\Controller\User\API\Pay\PayOrder::class, "async"], "ALL"); 
Route::add("/pay/sync", [\App\Controller\User\Pay\PayOrder::class, "sync"], "GET");  

Route::add("/pay/list", [\App\Controller\User\API\Pay\Pay::class, "getList"], "POST");
Route::add("/pay/getOrder", [\App\Controller\User\API\Pay\PayOrder::class, "getPayOrder"], "POST");
...
Route::add("/user/shop/supply/trade", [\App\Controller\User\API\Shop\Supply::class, "trade"], "POST"); 
...
Route::add("/user/trade/order/receipt", [\App\Controller\User\API\Trade\Order::class, "receipt"], "POST"); 
...
Route::add("/language/pack", [\App\Controller\Language::class, "pack"], "GET");   
Route::add("/language/record", [\App\Controller\Language::class, "record"], "POST");    

Route::add("/install", [\App\Controller\Install::class, "step"], "GET");
Route::add("/install/submit", [\App\Controller\Install::class, "submit"], "POST");
Route::add("/install/rewrite", [\App\Controller\Install::class, "rewrite"], "GET");
