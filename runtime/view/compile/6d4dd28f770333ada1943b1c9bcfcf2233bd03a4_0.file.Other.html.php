<?php
/* Smarty version 3.1.46, created on 2026-05-01 21:29:28
  from '/www/wwwroot/pcccc.cc/app/View/Admin/Config/Other.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.46',
  'unifunc' => 'content_69f4aab8c42ae9_04265423',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6d4dd28f770333ada1943b1c9bcfcf2233bd03a4' => 
    array (
      0 => '/www/wwwroot/pcccc.cc/app/View/Admin/Config/Other.html',
      1 => 1777554955,
      2 => 'file',
    ),
  ),
...
function content_69f4aab8c42ae9_04265423 (Smarty_Internal_Template $_smarty_tpl) {
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    ...
                                    <div class="d-flex align-items-center mt-3">
                                        ...
                                        <!--begin::Option-->
                                        <label class="form-check form-check-inline form-check-solid me-5">
                                            <input class="form-check-input" name="cash_type_usdt" type="checkbox"
                                                   value="1" <?php if ($_smarty_tpl->tpl_vars['config']->value['cash_type_usdt'] == 1) {?> checked <?php }?>>
                                            <span class="fw-bold ps-2 fs-6">USDT(TRC20)</span>
                                        </label>
                                        <!--end::Option-->
                                        <!--begin::Option-->
                                        <label class="form-check form-check-inline form-check-solid me-5">
