...
/* Smarty version 3.1.46, created on 2026-05-01 17:08:36
  from '/www/wwwroot/pcccc.cc/app/View/Admin/Dashboard/Index.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.46',
  'unifunc' => 'content_69f46d94916855_04804735',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '07ad8a0780507364fcfff31033486e3652275fe7' => 
    array (
      0 => '/www/wwwroot/pcccc.cc/app/View/Admin/Dashboard/Index.html',
      1 => 1777613316,
      2 => 'file',
    ),
  ),
...
function content_69f46d94916855_04804735 (Smarty_Internal_Template $_smarty_tpl) {
...
echo $_smarty_tpl->tpl_vars['user']->value['avatar'];
                                        ...
                                        <div>
                                            <h5 class="mb-1 fw-bold fs-4 text-danger"><?php echo $_smarty_tpl->tpl_vars['user']->value['nickname'];?>
</h5>
                                            <div class="d-flex align-items-center opacity-75">
                                                <span class="small text-primary"><i class="fa-duotone fa-regular fa-envelope text-primary"></i> <?php echo $_smarty_tpl->tpl_vars['user']->value['email'];?>
</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="d-flex align-items-center p-3 rounded bg-light bg-opacity-50 info-item">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="fw-medium text-success"><?php echo $_smarty_tpl->tpl_vars['user']->value['login_ip'];?>
</div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="fw-medium">
                                                    <?php if ($_smarty_tpl->tpl_vars['user']->value['last_login_ip']) {?>
                                                        <div class="text-warning"><?php echo $_smarty_tpl->tpl_vars['user']->value['last_login_ip'];?>
</div>
                                                        <div class="text-muted small"><?php echo $_smarty_tpl->tpl_vars['user']->value['last_login_time'];?>
</div>
                                                    <?php } else { ?>
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="bg-success bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center"
                                                ...
                                                <i class="fa-duotone fa-regular fa-money-bills text-success" style="font-size: 20px;"></i>
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                            <h6 class="card-title mb-0 text-muted small">盈利</h6>
                                        </div>
                                    </div>
                                    <div class="order_profit fw-bold fs-4 text-success">...</div>
                                </div>
                            </div>
                        </div>
